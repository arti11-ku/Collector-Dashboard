...
export function Onboarding() {
  ...
  const handleDetectLocation = () => {
    ...
    if (demoLocation) {
      ...
      setError('');
      setResolvedLocation(demoLocation);
      setLatitude(demoLocation.latitude ?? null);
      setLongitude(demoLocation.longitude ?? null);
      setAddress(demoLocation.formattedAddress);
