  ...
  return (
    <div className="bg-white border border-[#E0E7E1] rounded-3xl overflow-hidden shadow-sm min-h-[80vh]">
      ...
      <div className="border-b border-[#E0E7E1] bg-[#F9FBFA] px-4 py-3 overflow-x-auto whitespace-nowrap hide-scrollbar flex space-x-2">
        {['ALL', 'PENDING_HANDOVER', 'HANDOVER_CONFIRMED', 'PAYMENT_PROCESSING', 'COMPLETED'].map(f => (
          <button
            key={f}
            onClick={() => setFilter(f)}
            ...
            {filteredLots.map(lot => (
              ...
              >
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <p className="text-sm text-[#5A7A54]">Estimated value: {(lot.referencePrice?.total || lot.agreedAmount) ? `₹${(lot.referencePrice?.total || lot.agreedAmount || 0).toLocaleString()}` : 'Reference value unavailable'}</p>
